...
namespace standalone {
	...
	unsigned int BigInteger::get_num_of_digits(int value) const {
		unsigned int num_of_digits = this->get_num_of_digits(static_cast<long long>(value));
	...
	std::ostream& standalone::operator << (std::ostream& out, const BigInteger& big_integer) {
		// Print minus sign
	...
	std::istream& standalone::operator >> (std::istream& in, BigInteger& big_integer) {
