...
namespace abstract_bignumber {
	...
	std::ostream& abstract_bignumber::operator << (std::ostream& out, const BigInteger& big_integer) {
		// Print minus sign
	...
	std::istream& abstract_bignumber::operator >> (std::istream& in, BigInteger& big_integer) {
